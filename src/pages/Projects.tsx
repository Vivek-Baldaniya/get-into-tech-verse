          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our proven project delivery methodology ensures consistent
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600">
                  We handle deployment and provide comprehensive support to
                  ensure your solution performs optimally in production.
                </p>
              </div>
            </div>
          </div>
